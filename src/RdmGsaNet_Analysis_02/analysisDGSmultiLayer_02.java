...
public class analysisDGSmultiLayer_02 extends analysisMain implements analysisDGS {
	...
	// COSTANTS
		...
		// COSTRUCTOR 
		public analysisDGSmultiLayer_02 (boolean run ,  boolean doGsViz , boolean doNetViz , boolean doVecViz , boolean doSeedViz,  boolean computeGlobalCorrelation ) {
			this.run = run ;
